...
export default function ProjectForm({
    ...
    return (
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Form Header */}
            <div className="px-4 py-4 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                ...
                <div className="hidden sm:flex gap-3">
                    <button
                        ...
                        className="px-4 py-2 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 text-sm font-bold transition-all"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        style={{borderRadius: '10px'}}
                        className="px-4 py-2 rounded-xl bg-[#1800ad] text-white text-sm font-bold hover:bg-[#150091] transition-all shadow-lg shadow-blue-100"
                    >
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-8 space-y-12">
                ...
                <div className="space-y-6 mt-4">
                    <div className="flex items-center gap-2 text-purple-600 border-b border-purple-50 pb-4">

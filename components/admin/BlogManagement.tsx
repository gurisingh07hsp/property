...
const deleteBlog = async (id: string) => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      ...
      <button style={{borderRadius: '8px'}} onClick={()=> setIsOpen(true)} className="bg-[#1800ad] text-white cursor-pointer flex items-center justify-center p-2 rounded-lg hover:bg-primary/90">

                                                        ...
                                                        <div className="property-grid-card bg-white p-3 rounded-4 shadow-sm h-100 border">
                                                            <div className="img1 image-anime mb-3 position-relative">
                                                                ...
                                                                <div className="position-absolute top-0 inset-e-0 m-2">
                                                                    <span style={{display: 'flex'}} className="badge bg-primary rounded-pill px-3 py-2 flex items-center gap-1">
                                                            ...
                                                            <div className="content-tab-area">
                                                                ...
                                                                <div className="mt-2 d-flex gap-2">
                                                                    <button onClick={() => { handleEdit(property); setMode('edit'); setOpen(true)}} className="btn btn-outline-primary btn-sm grow d-flex align-items-center justify-content-center gap-1 rounded-3 py-1" style={{fontSize: '12px'}}>
                                                                        <Edit size={14} /> Edit
                                                                    </button>

                                                ...
                                                {properties.map((property)=> (
                                                     ...
                                                     <div key={property._id} className="table-row">
                                                                        ...
                                                                        <div className="property-other-widget">
                                                                            <ul>
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    {property.additionalInformation.rooms}
                                                                                </li>
                                                                                <li>
                                                                                    <span>
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                                                                    ...
                                                                                    {property.additionalInformation.bathrooms}
                                                                                </li>
                                                                            </ul>
                                                        ...
                                                        <div className="actions w-lg-25">
                                                            <button onClick={() => { handleEdit(property); setMode('edit'); setOpen(true)}} className="edit flex">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                                            ...
                                                            <button className="sold flex mt-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                                            ...
                                                            <button onClick={()=> handleDelete(property._id || "")} className="delete flex mt-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">

                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img1.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img2.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img3.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img4.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img5.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>
                                    ...
                                    <div className="col-lg-4 col-4">
                                        <div className="footer-img">
                                            <img src="/assets/img/all-images/footer/footer-img6.png" alt="housa" />
                                            <div className="icons">
                                                <Link href="#">
                                                    <i className="fa-brands fa-instagram" />
                                                </Link>

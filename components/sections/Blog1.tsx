...
export default function Blog1() {
    return (
        <>
            ...
            <div className="vl-blog-1-area container-home1 overflow-hidden">
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-lg-4  col-md-6" data-aos="fade-left" data-aos-duration={900}>
                            <div className="vl-blog-1-item">
                                <div className="vl-blog-1-thumb">
                                    <Link href="/blog-detail">
                                        <img src="/assets/img/all-images/blog/blog-img1.png" alt="housa" />
                                    </Link>
                                </div>
                                <div className="vl-blog-1-content">
                                    ...
                                    <div className="vl-blog-meta">
                                        <ul>
                                            <li>
                                                <Link href="#">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                                        <g clipPath="url(#clip0_6058_73650)">
                                                            <path
                                                                fillRule="evenodd"
                                                                clipRule="evenodd"
                                            ...
                                            <li>
                                                <Link href="#">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                                        <g clipPath="url(#clip0_6058_73657)">
                                                            <path
                                    ...
                                    <h4 className="vl-blog-1-title">
                                        <Link href="/blog-detail">5 Tips For First-Time Homebuyers Housa</Link>
                                    </h4>
                                    <div className="space24" />
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration={1000}>
                            <div className="vl-blog-1-item">
                                <div className="vl-blog-1-thumb">
                                    <Link href="/blog-detail">
                                        <img src="/assets/img/all-images/blog/blog-img2.png" alt="housa" />
                                    </Link>
                                </div>
                                <div className="vl-blog-1-content">
                                    <div className="date">
                                    ...
                                    <div className="space24" />
                                    <h4 className="vl-blog-1-title">
                                        <Link href="/blog-detail">Understanding the Latest Real Estate Market Trends</Link>
                                    </h4>
                                    <div className="space24" />
                                    <div className="vl-blog-1-icon">
                                        <Link href="/blog-detail" className="readmore">
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration={1000}>
                            <div className="vl-blog-1-item">
                                <div className="vl-blog-1-thumb">
                                    <Link href="/blog-detail">
                                        <img src="/assets/img/all-images/blog/blog-img3.png" alt="housa" />
                                    </Link>
                                </div>
                                <div className="vl-blog-1-content">
                                    <div className="date">
                                    ...
                                    <div className="space24" />
                                    <h4 className="vl-blog-1-title">
                                        <Link href="/blog-detail">How to Stage Your Home for a Quick Sale</Link>
                                    </h4>
                                    <div className="space24" />
                                    <div className="vl-blog-1-icon">
                                        <Link href="/blog-detail" className="readmore">
